package us.pdavidson.jhipster.token.web.rest;
...
import us.pdavidson.jhipster.token.repository.AuthorRepository;
...
@WebAppConfiguration
@IntegrationTest
public class AuthorResourceTest extends AbstractCassandraTest {
    ...
    public void getAllAuthors() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors"))
                ...
                .andExpect(jsonPath("$.[0].id").value(author.getId().toString()))
                .andExpect(jsonPath("$.[0].name").value(DEFAULT_NAME.toString()))
                .andExpect(jsonPath("$.[0].birthDate").value(DEFAULT_BIRTH_DATE.getTime()));
    }
    ...
    public void getAuthor() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors/{id}", author.getId()))
            ...
            .andExpect(jsonPath("$.birthDate").value(DEFAULT_BIRTH_DATE.getTime()));
    }
